...
public class MethodReferenceConstructor {
    ...
    private static String concatWithNoArgsConstructor(String name1,
                                                      String name2) {
    ...
    private static String concatWithSingleArgConstructor(String name1,
                                                         String name2) {
        // method reference is related to object creation with ::new (when
        //      the only thing that the method do is to create an instance
        // It can take one parameter and still uses the same MR syntax with
        //      ::new (the parameter is inferred)
